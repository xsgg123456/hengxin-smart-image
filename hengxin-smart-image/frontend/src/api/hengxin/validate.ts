...
const round: Guard<Round> = (value): value is Round => record(value)
  && (value.baseVersionId == null || id(value.baseVersionId))
  && (value.baseVersion == null || (count(value.baseVersion) && value.baseVersion > 0))
  && (value.annotation == null || uploadedPicture(value.annotation))
