...
async function remove(a: Archive) {
  try { await ElMessageBox.confirm('删除这条归档？对应任务结果保留。', '删除成品', { confirmButtonText: '删除', cancelButtonText: '取消', type: 'warning' }) }
  catch { return }
  try { await removeArchive(a) }
