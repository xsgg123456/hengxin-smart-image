<template>
  <ElCard class="art-card hx-section">
    ...
    <ElForm v-loading="loading" label-position="top" :disabled="loading || saving || !ready || props.disabled">
      ...
      <ElButton type="primary" :loading="saving" :disabled="!ready || loading || props.disabled" @click="save">保存默认绑定</ElButton>
    </ElForm>
  </ElCard>
</template>
