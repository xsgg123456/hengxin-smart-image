...
async def parse_upload(request: Request, limit=MAX_UPLOAD_BYTES):
    ...
    body_limit = min(limit, MAX_UPLOAD_BYTES) + 64 * 1024
    ...
    try:
        ...
        raise HTTPException(413, f'单张图片不能超过 {limit / 1024**2:g} MiB') from None
